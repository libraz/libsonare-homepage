...
| ピッチ輪郭を音階へスナップ（オートチューン） | `pitchCorrectTimevarying(samples, f0Hz, sampleRate, hopLength, options)` | `pitch_correct_timevarying(samples, f0_hz, sample_rate, hop_length, options)` |
