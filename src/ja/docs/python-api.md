...
| プロジェクト | `AssistSidecar`（`project.get_assist_sidecar(index)` / `project.assist_sidecars()` の戻り値 — [プロジェクト編集](./project-editing.md#アシストサイドカー) を参照）、`ProjectDiagnostic`、`NotePairValidation` |
