...
| ルーム音響解析 | インパルスレスポンスの残響時間（RT60 / EDT）、明瞭度（C50 / C80）、定義度（D50）解析、通常録音からのブラインド音響推定 | [ルーム音響解析](./acoustic-analysis.md)、[JavaScript API](./js-api.md#ルーム音響解析)、[Python API](./python-api.md#ルーム音響解析) |
