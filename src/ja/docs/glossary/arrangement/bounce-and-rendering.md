...
以下の信号経路はライブ再生時に聞こえているものとまったく同じです — バウンスは単に、それをオーディオデバイスの代わりにファイルへキャプチャしているだけです。

<FlowDiagram
  title="バウンスの信号経路"
  :nodes="[
    { id: 'clips', label: 'トラックのクリップ', col: 0, row: 0 },
    { id: 'strip', label: 'チャンネルストリップ', col: 1, row: 0, variant: 'accent' },
    { id: 'sends', label: 'FX へのセンド', col: 2, row: 0, variant: 'muted' },
    { id: 'bus', label: 'バス', col: 3, row: 0 },
    { id: 'master', label: 'マスター', col: 4, row: 0 },
    { id: 'file', label: '完成オーディオファイル', col: 5, row: 0, variant: 'success' }
  ]"
  :edges="[
    { from: 'clips', to: 'strip' },
    { from: 'strip', to: 'sends' },
  ...
  caption="各トラックの EQ・ダイナミクス・ゲイン・センドは、バウンスが書き出される前にバスとマスターを通して合算されます。"
/>
