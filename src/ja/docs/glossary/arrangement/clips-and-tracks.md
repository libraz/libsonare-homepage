...
<FlowDiagram
  ...
  :nodes="[
    ...
    { id: 'clipVerse', label: 'クリップ: verse vocal', col: 0, row: 2 },
    { id: 'clipChorus', label: 'クリップ: chorus vocal', col: 1, row: 2 },
    { id: 'clipDrum', label: 'クリップ: drum loop', col: 2, row: 2 },
    { id: 'clipBass', label: 'クリップ: bass line', col: 3, row: 2 },
    { id: 'destination', label: 'MIDI 宛先', col: 3, row: 3, variant: 'accent' },
  ...
  caption="オーディオトラックはすでに音を保持しているため、そのまま再生されます。一方、MIDI トラックのクリップが持つのはノートだけなので、トラックは別途、楽器にバインドされた宛先へルーティングし、バウンス時にそこで音がレンダリングされます。"
/>
