...
**ピッチベンド**は独自の高分解能メッセージ（CC ではありません）で、ノートのピッチを連続的に上下へスライドさせます — ギターのチョーキング、ビブラート、アームの効果などに使います。フルベンドがどこまで届くか、すなわちピッチベンドレンジは、ピッチベンドメッセージ自体には含まれず、後述の RPN メッセージで別に設定します。
