...
LUFS は体感上の音量、つまり聴く人が時間全体でどれくらい大きく感じるかを表す単位です。単なるピークレベル（瞬間的な波形のいちばん高い値）よりもマスタリングで有用なのは、一瞬のピークの大きさだけでは曲全体がどれくらい大きく感じられるかがわからないからです。
...
積分 LUFS の値は、ファイル全体の平均ではありません。ラウドネスは短いブロック単位で測られ、どのブロックを数えてよいかを 2 つのゲートが決めます。まず -70 LUFS の絶対ゲートが無音を落とし、次に生き残った平均より 10 LU 下の相対ゲートが小さい音の部分も落とします。
