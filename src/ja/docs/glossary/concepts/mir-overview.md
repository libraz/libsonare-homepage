...
<FlowDiagram
  ...
  caption="ひとつの STFT がすべての分岐に供給されるため、同じ素材で複数の特徴量を求めても、同じ中間表現を再利用するだけで再計算にはなりません。"
/>
...
**ピッチ推定**は基本周波数を追跡します。基本周波数とは、音の高さとして聞こえる最も低く強い周波数のことです。メロディ、ボーカル、単音楽器、チューニング確認、採譜系のワークフローで使えます。
