...
| ステレオ | 広がりが楽曲を助けているか、[モノラル](./mono-compatibility.md)の芯を弱めていないか。 |
...
一番多い失敗は、[ラウドネスを揃えず](./loudness-matching.md)にリファレンスと比べることです。商用リファレンスは自分のミックスより大きく、密度も高いことが多く、それだけで良く聞こえてしまいます。
