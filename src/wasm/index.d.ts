 ...
 */
declare function spectralBandwidth(request: SpectralFrameRequest): Float32Array;
 ...
 */
declare function detectOnsets(request: SamplesRequest): Float32Array;
