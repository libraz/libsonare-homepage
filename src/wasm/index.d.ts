 ...
 */
type VoicedFlags = Int32Array | Uint8Array | Float32Array | readonly number[] | readonly boolean[];
...
declare function pitchCorrectToMidiTimevarying(samples: Float32Array, f0Hz: Float32Array, targetMidi: number, sampleRate?: number, hopLength?: number, voiced?: VoicedFlags, voicedProb?: Float32Array, options?: ValidateOptions): Float32Array;
/**
 ...
 */
declare function masteringAssistantSuggestStereo(request: MasteringStereoParamsRequest): string;
/**
 ...
 */
declare function masteringAudioProfileStereo(request: MasteringStereoParamsRequest): string;
/**
 ...
 */
declare function masteringStreamingPreviewStereo(request: MasteringStreamingPreviewStereoRequest): string;
 ...
 */
declare function meteringCrestFactorDbStereo(request: MeteringStereoRequest): number;
